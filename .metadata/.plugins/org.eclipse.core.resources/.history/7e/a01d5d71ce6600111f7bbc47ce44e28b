...
public class FormularioProducto extends JDialog implements Serializable {
	...
	private JComboBox <String> cbmStock;
    ...
    private JPanel crearPanelCampos() {
    	...
    	cbmStock = new JComboBox<>(new String[] {"Disponible", "agotado"});
